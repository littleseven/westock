...
from app.strategies import ichimokuStrat1

import pandas

from PySide2.QtWidgets import QApplication, QGridLayout, QMainWindow, QGraphicsView, QComboBox, QLabel
...
backtest = bt.Backtest(dataframe,ichimokuStrat1)
backtest.run()
