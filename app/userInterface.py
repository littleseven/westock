...
class UserInterface:
    ...
    def fillStrategyParameters(self, strategy):
        ...
        # Rest widget rows
        self.strategyTesterUI.parametersLayout = self.strategyTesterUI.findChild(QtWidgets.QFormLayout, "parametersLayout")
        self.strategyTesterUI.parametersScrollArea = self.strategyTesterUI.findChild(QtWidgets.QScrollArea, "parametersScrollArea")
